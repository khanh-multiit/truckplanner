    ...
    <div className={'content-block'}>
      <div className={'dx-card responsive-paddings'}>
        ...
        <ul>
          <li>
            <a
              href={'https://js.devexpress.com/Documentation/Guide/React_Components/Application_Template/#Layouts'}
              target={'_blank'}
              rel={'noopener noreferrer'}
            >
              Layouts
        ...
        <p>
          ...
          <a href="https://js.devexpress.com/documentation/" target="_blank" rel="noopener noreferrer">
            online documentation
          </a>
          <span> and </span>
          <a href="https://js.devexpress.com/Demos/Widgetsgallery/" target="_blank" rel="noopener noreferrer">
            technical demos
          </a>
          .
        </p>
